...
#define INPUT_ANALOG_PORT_INDEX_OFFSET 11
...
void input_setup() {
  ...
  OCR1A = 155  ;             // Output Compare für call alle 10 ms https://timer-interrupt-calculator.simsso.de/
  TCCR1B |= (1 << CS12)|(1 << CS10);    // 1024 als Prescale-Wert spezifizieren
